...
public class Worker {
    ...
    public static void downloadFile(FileDescriptor fileDescriptor) throws Exception {
        ...
        FileDescriptor localFile = new FileDescriptor();
        localFile.setPath(fileDescriptor.getName());
        localFile.setRoot(""); //TODO !!!

        TempFile tempFile = TempFile.getInstance(fileDescriptor.getAbsolutePath());
        try {
